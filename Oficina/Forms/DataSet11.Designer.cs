...
namespace Oficina {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public UsuariosRow AddUsuariosRow(string nome, string senha, int nivel) {
...
namespace Oficina.DataSet1TableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_senha = 1 AND [senha] IS NULL) OR ([senha] = @Original_senha)) AND ((@IsNull_nivel = 1 AND [nivel] IS NULL) OR ([nivel] = @Original_nivel)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [nome] = @nome, [senha] = @senha, [nivel] = @nivel WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_senha = 1 AND [senha] IS NULL) OR ([senha] = @Original_senha)) AND ((@IsNull_nivel = 1 AND [nivel] IS NULL) OR ([nivel] = @Original_nivel)));
SELECT Id, nome, senha, nivel FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Oficina.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, nome, senha, nivel FROM dbo.Usuarios";
